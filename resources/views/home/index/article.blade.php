...
@section('content')
   <!--bắt đầu bài viết bên trái-->
    <div class="col-xs-12 col-md-12 col-lg-8">
        ...
        <!-- Giới thiệu bắt đầu nhận xét chung -->
        <script>
...
@section('js')
    <script>
        ...
        translate = {
            pleaseLoginToComment: "{{ translate('Vui lòng đăng nhập để bình luận') }}",
            pleaseLoginToReply: "{{ translate('Vui lòng đăng nhập để trả lời') }}",
            emailForNotifications: "{{ translate('Thông báo qua Email') }}",
            pleaseLogin: "{{ translate('Vui lòng đăng nhập') }}",
            reply: "{{ translate('Trả lời') }}"
        }
